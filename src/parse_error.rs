...
impl IntoRust for wasm::ParseError {
    ...
    fn into_rust(self) -> rust::ParseError {
        match self {
            wasm::ParseError::UnrecognizedArchitecture(s) => {
                rust::ParseError::UnrecognizedArchitecture(s)
            }
            wasm::ParseError::UnrecognizedVendor(s) => rust::ParseError::UnrecognizedVendor(s),
            wasm::ParseError::UnrecognizedOperatingSystem(s) => {
                rust::ParseError::UnrecognizedOperatingSystem(s)
            }
            wasm::ParseError::UnrecognizedEnvironment(s) => {
                rust::ParseError::UnrecognizedEnvironment(s)
            }
            wasm::ParseError::UnrecognizedBinaryFormat(s) => {
                rust::ParseError::UnrecognizedBinaryFormat(s)
            }
